...
class Decode{
    ...
    void initialise() {
        ifstream ifile("C:/Users/hp/Downloads/RISC-V-GUI-master/Project/ALU.txt");
        string line,temp;
